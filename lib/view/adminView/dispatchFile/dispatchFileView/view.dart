...
import '../dispatchFileUploadForm/disptachfileUploadForm.dart';
import '../dispatchFilesList/filesListViewbuilder.dart';
import 'index.dart';
...
class dispatchView extends GetView<dispatchController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: TextWidget(title: 'Dispatch Files',textColor: AppColors.tittleColour,fontSize: 20,),
      ),
