                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Obx(
                              () => Text(
                                  "Departments: ${controller.state.selectedDepartments.join(', ')}"),
                            ),
                          ],
                        ),
                        SizedBox(
                              ...
                              ? ReuseButton(
                                  ...
                                  onpress: () {
                                    ...
                                    controller.uploadDiaryNumberFiles(
                                        ...
                                        controller.state.serialNumController.text
                                            .trim(),
                                        controller.state.selectedDate,
                                        controller.state.dispatchSelDate,
                                        controller.state.senderNameController.text
                                            .trim(),
                                        controller
                                            .state.receiverNameController.text
                                            .trim(),
                                        controller
                                            .state.senderAddressController.text
                                            .trim(),
                                        controller.state.deptName.value.trim(),
                                        controller
                                            .state.fileSubjectController.text
                                            .trim());
                                  })
                              : Center(
                                  child: CircularProgressIndicator(
                                    color: AppColors
                                        .filesCircularProgessIndicatorColour,
                                  ),
                                ),
                        )
                      ],
